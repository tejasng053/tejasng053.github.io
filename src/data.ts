...
export const repositories: Repository[] = [
  ...
  { name: 'Printly', description: 'Student document-upload and printing service with separate user and admin surfaces.', language: 'JavaScript', updated: 'Apr 2026', url: 'https://github.com/tejasng053/Printly', live: 'https://printly-theta.vercel.app/', kind: 'Project' },
