...
export const featuredProjects: FeaturedProject[] = [
  {
    ...
    stack: ['Python', 'PyTorch', 'TensorFlow', 'Pix2Pix', 'CNN'],
...
export const repositories: Repository[] = [
  ...
  { name: 'echocardiogram', description: 'Reproducible research kit for left-ventricle segmentation in echocardiography.', language: 'Python', updated: 'Aug 2026', url: 'https://github.com/tejasng053/echocardiogram', kind: 'Project' },
